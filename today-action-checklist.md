...
2. Keep one campaign, but split ad groups by intent:
...
3. Pause or reduce any ad group that brings grocery, kirana, shop act, trade license, food license, restaurant, or street-vendor enquiries.
4. Use scope-first ad copy. Do not promise fixed pricing.
...
4. Confirm the sheet includes the new `preferred_time` column.
